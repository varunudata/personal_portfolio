            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="grid md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <h2 className="text-2xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent mb-4 inline-block">
                            Varun Udata.
                        </h2>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-textSecondary">
                            ...
                            <li>
                                <Link to="contact" smooth={true} duration={500} className="text-primary hover:text-secondary cursor-pointer font-medium">
                                    Send a message &rarr;
                                </Link>
                            </li>
                        </ul>
